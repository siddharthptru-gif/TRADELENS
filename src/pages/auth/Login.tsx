  ...
  return (
    <div className="flex items-center justify-center min-h-[90vh] px-4 relative overflow-hidden bg-[#020403]">
      ...
      <GlassCard className="w-full max-w-md p-8 relative z-10 text-center">
        ...
        <h2 className="text-3xl font-serif text-white mb-2 tracking-tight">Welcome to TradeLens AI</h2>
        <p className="text-muted text-sm mb-8">
          Continue with Google to analyze charts, save reports, and build your trading journal.
        </p>
