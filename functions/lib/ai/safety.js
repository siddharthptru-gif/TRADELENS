...
exports.containsForbiddenPhrase = containsForbiddenPhrase;
exports.sanitizeReport = sanitizeReport;
exports.validateSafety = validateSafety;
...
function containsForbiddenPhrase(text) {
    ...
    for (const phrase of exports.FORBIDDEN_PATTERNS) {
...
function validateSafety(report) {
